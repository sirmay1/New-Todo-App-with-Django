...
SECRET_KEY = 'django-insecure-k=!5=me45_(+%1d7v3e_m)=zd5%4)_mn=ehh028!oebrhu+rye'
...
# NOTE: (04/18/2023) for path make sure you link the static file only to the app within your project. 
STATICFILES_DIRS = [
